...
import me.sobki.animatedleaves.ReflectionHandler.PackageType;
...
public enum ParticleEffect {
	...
	public static abstract class ParticleData {
		...
		/**
		 * Sets the packet data. Should be an integer array. For ITEM_CRACK and BLOCK_DUST, it should be [id, meta] but for BLOCK_CRACK it should be [id + (meta * 4096)]
		 * 
		 * @param data
		 *            The packet data.
		 */
	...
	public static final class ParticlePacket {
		 ...
		 */
		public void sendTo(Location center, Player... players) throws IllegalArgumentException {
			if (players.length == 0) {
